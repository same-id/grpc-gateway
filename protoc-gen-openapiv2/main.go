...
var (
	...
	allowWriteOnlyAttribute        = flag.Bool("allow_write_only_attribute", false, "if set, enables the writeOnly attribute which is only available in Open API v3, but some tools (like ReDoc) may support it for v2.")
)
